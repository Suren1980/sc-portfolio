  ...
  return (
    <div name="home" className="w-full h-screen bg-[#5cdb95]">
      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        <p className="text-[#379683]">Hi, my name is</p>
        <h1 className="text-4xl sm:text-7xl font-bold text-white">
          Surender Chawla
        </h1>
        <h2 className="text-2xl sm:text-5xl font-bold text-[#EDF5E1]">
          I'm a Director in IT Technologies with expertise in Microsoft Dynamics
          and Application Support at Pride Technologies..
        </h2>
        <p className="text-[#EDF5E1] py-4 max-w-[900px]">
        ...
        <div>
          <Link
            ...
            smooth={true}
            duration={500}
            className=" w-[170px] cursor-pointer text-white group border-2 px-6 py-3 my-2 flex items-center hover:bg-custom-blue hover:border-custom-blue"
          >
            View Work
